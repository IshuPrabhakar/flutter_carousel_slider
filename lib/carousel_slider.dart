...
import 'carousel_controller.dart' as carosal;
...
class CarouselSlider extends StatefulWidget {
  ...
  final carosal.CarouselControllerImpl _carouselController;
  ...
  CarouselSlider(
      ...
      this.disableGesture,
      carosal.CarouselController? carouselController,
      Key? key})
      : itemBuilder = null,
        itemCount = items != null ? items.length : 0,
        _carouselController = carouselController != null
            ? carouselController as carosal.CarouselControllerImpl
            : carosal.CarouselController() as carosal.CarouselControllerImpl,
        super(key: key);
...
class CarouselSliderState extends State<CarouselSlider>
  ...
  final carosal.CarouselControllerImpl carouselController;
  Timer? timer;
